...
export const deck_card_ids: () => [number, number, number, number];
export const deck_card_name: (a: number, b: number) => [number, number, number, number];
...
export const deck_view: () => [number, number, number, number];
