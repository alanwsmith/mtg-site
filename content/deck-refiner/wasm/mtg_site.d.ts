...
export class Deck {
    ...
    static decrement_quantity(uid: string): void;
    ...
    static output_json_storage(): string;
...
export interface InitOutput {
    ...
    readonly deck_decrement_quantity: (a: number, b: number) => [number, number];
    ...
    readonly deck_output_json_storage: () => [number, number, number, number];
